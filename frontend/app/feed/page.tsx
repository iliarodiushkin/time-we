    ...
    <div style={{minHeight:"100vh", background:"#F8F7FF"}}>
      ...
      <header className="app-header-mobile" style={{
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"10px 16px 8px" }}>
          ...
          {/* Навигация + сброс — SVG иконки как в AppHeader */}
          <div style={{ display:"flex", alignItems:"center", gap:2 }}>
            {([
              { href:"/feed", active:true, svg: <svg width="18" height="18" viewBox="0 0 24 24" fill={P} stroke={P} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { href:"/favorites", active:false, svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#B2BEC3" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg> },
              { href:"/shared-plans", active:false, svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#B2BEC3" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> },
              { href:"/profile", active:false, svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#B2BEC3" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> },
            ] as {href:string,active:boolean,svg:React.ReactNode}[]).map(item => (
              <button key={item.href} onClick={() => router.push(item.href)}
                style={{ width:32, height:32, borderRadius:8, border:"none", background:item.active?"#F0EEFF":"transparent", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center" }}>
                {item.svg}
              </button>
            ))}
